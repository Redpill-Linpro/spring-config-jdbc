...
/**
 * Unit tests for {@link JdbcPlaceholderConfigurer}.
 *
 */
public class JdbcPlaceholderConfigurerTests {
	...
	private JdbcPlaceholderConfigurer jpc;
	...
	public void setUp() {
		...
		jpc = new JdbcPlaceholderConfigurer();
		jpc.setProperties(jpcProperties);
		Resource resource = new ClassPathResource("JdbcPlaceholderConfigurerTests.properties", this.getClass());
		jpc.setLocation(resource);
                jpc.setDataSource(db);
		jpc.afterPropertiesSet();				
	}	
